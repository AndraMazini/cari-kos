        ...
        <form action="{{ route('login.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" class="w-full pl-10 border border-gray-300 rounded-lg px-3 py-2 focus:border-green-500 focus:ring-1 focus:ring-green-500 outline-none" required>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" class="w-full pl-10 border border-gray-300 rounded-lg px-3 py-2 focus:border-green-500 focus:ring-1 focus:ring-green-500 outline-none" required>
                </div>
            </div>
